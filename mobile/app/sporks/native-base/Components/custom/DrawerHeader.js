/*prettydiff.com methodchain:true */
  ...
  getInitialStyle () {
    return {
      navbar: {
        ...
        justifyContent: (!Array.isArray(this.props.children) && Platform.OS == 'ios')
          ? 'center'
          : 'space-between',
        flexDirection: 'row',
        alignItems: 'center',
        paddingLeft: (!Array.isArray(this.props.children) && Platform.OS == 'android')
          ? 30
          : undefined,
